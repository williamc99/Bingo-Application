...
'
'	PROGRAMME OUTLINE	:	This form allows the user to generate bingo cards and play full bingo.
'                           When full bingo is achieved, it will show a messagebox and will prompt
...
Public Class frmBingoCardFull
    ...
    Private Sub btnB1_Click(sender As Object, e As EventArgs) Handles btnB1.Click, btnB2.Click, btnB3.Click, btnB4.Click, btnB5.Click, btnI1.Click, btnI2.Click, btnI3.Click, btnI4.Click, btnI5.Click, btnN1.Click, btnN2.Click, btnN3Free.Click, btnN4.Click, btnN5.Click, btnG1.Click, btnG2.Click, btnG3.Click, btnG4.Click, btnG5.Click, btnO1.Click, btnO2.Click, btnO3.Click, btnO4.Click, btnO5.Click
        ...
        If btnB1.BackColor = Color.Black And btnB2.BackColor = Color.Black And btnB3.BackColor = Color.Black And btnB4.BackColor = Color.Black And btnB5.BackColor = Color.Black And btnI1.BackColor = Color.Black And btnI2.BackColor = Color.Black And btnI3.BackColor = Color.Black And btnI4.BackColor = Color.Black And btnI5.BackColor = Color.Black And btnN1.BackColor = Color.Black And btnN2.BackColor = Color.Black And btnN3Free.BackColor = Color.Black And btnN4.BackColor = Color.Black And btnN5.BackColor = Color.Black And btnG1.BackColor = Color.Black And btnG2.BackColor = Color.Black And btnG3.BackColor = Color.Black And btnG4.BackColor = Color.Black And btnG5.BackColor = Color.Black And btnO1.BackColor = Color.Black And btnO2.BackColor = Color.Black And btnO3.BackColor = Color.Black And btnO4.BackColor = Color.Black And btnO5.BackColor = Color.Black Then
            MessageBox.Show("Congrats on a FULL Bingo!", "BINGO!", MessageBoxButtons.OK, MessageBoxIcon.Information)
